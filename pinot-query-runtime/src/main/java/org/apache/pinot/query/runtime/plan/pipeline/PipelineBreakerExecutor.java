...
public class PipelineBreakerExecutor {
   ...
   */
  public static PipelineBreakerResult executePipelineBreakers(SchedulerService scheduler,
    ...
    if (pipelineBreakerContext.getPipelineBreakerMap().size() > 0) {
      ...
      PhysicalPlanContext physicalPlanContext =
          new PhysicalPlanContext(mailboxService, scheduler, requestId, stageRoot.getPlanFragmentId(), deadlineMs,
  ...
  private static PipelineBreakerResult execute(SchedulerService scheduler,
  ...
  private static PipelineBreakerResult runMailboxReceivePipelineBreaker(SchedulerService scheduler,
