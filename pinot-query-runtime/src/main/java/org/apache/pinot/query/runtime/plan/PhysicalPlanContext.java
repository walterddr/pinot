...
public class PhysicalPlanContext {
  ...
  public PhysicalPlanContext(MailboxService mailboxService, SchedulerService schedulerService, long requestId,
      int stageId, long deadlineMs, VirtualServerAddress server, StageMetadata stageMetadata,
