...
public class LiteralOnlyBrokerRequestTest {
  ...
  public void testBrokerRequestHandler()
    ...
    SingleConnectionBrokerRequestHandler requestHandler =
        new SingleConnectionBrokerRequestHandler(new PinotConfiguration(), "testBrokerId", null, null,
            ACCESS_CONTROL_FACTORY, null, null,
            new BrokerMetrics("", PinotMetricUtils.getPinotMetricsRegistry(), true, Collections.emptySet()), null, null,
            mock(ServerRoutingStatsManager.class), PinotBrokerQueryEventListenerFactory.getBrokerQueryEventListener());
